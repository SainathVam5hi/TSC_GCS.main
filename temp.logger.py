...
def sendDataToServer1():
	...
	hum ="%.1f" %humidity
	press = "%.1f" %pressure
	urllib2.urlopen("mysql://localhost//greenhouse_weather/weather/add_data.php?temp="+temp+"&hum="+hum+"&pr="+press).read()
    r = requests.post('https://maker.ifttt.com/trigger/temp/with/key/YOUR_KEY_HERE', params={"value1":"temperature","value2":"humidity","value3":"pressure"})
sendDataToServer1()
...
def sendDataToServer2():
	...
	hum ="%.1f" %humidity
	press = "%.1f" %pressure
	urllib2.urlopen("mysql://localhost//greenhouse_weather/weather2/add_data.php?temp="+temp+"&hum="+hum+"&pr="+press).read()
